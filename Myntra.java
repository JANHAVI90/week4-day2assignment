package Week4.day2;
		...
		public class Myntra {
			...
			String items1 = driver.findElement(By.xpath("//span[@class='title-count']")).getText();
			System.out.println("Total count of itmes : "+items1);
			...
			System.out.println("Jacket count : "+jacket);
			System.out.println("Rain Jacket count : "+rainJacket);
			...
			for (String webElement2 : brandName) {
				...
				WebElement webEle1 = driver.findElement(By.xpath("//div[@class='sort-sortBy']"));
				bulider.moveToElement(webEle1).perform();
